...
import { assertPhase, readState, scopePath, transition, writeState } from "../state.js";
import { toolResult } from "./_base.js";
function mergeList(current, add, remove) {
...
function applyAmendment(plan, amendment) {
    return {
        ...plan,
        scope: {
...
export async function handleAmendPlan(args) {
...
//# sourceMappingURL=amend_plan.js.map