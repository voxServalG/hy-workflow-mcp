...
export async function handleSyncDocs() {
    ...
    if (!state.plan)
        return toolResult("edit", { phase: state.phase, error: "No plan", allowedTools: ["hy_status"] });
...
//# sourceMappingURL=sync_docs.js.map