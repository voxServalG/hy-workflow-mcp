...
export const COMMAND_CONTRACTS: CommandContract[] = [
  { name: "hy_init", handlerFile: "src/tools/init.ts", docsFile: "docs/tools.md", phase: "init, plan", description: "Validate runtime readiness without consulting legacy injected artifacts", destructive: false },
  ...
  { name: "hy_approve", handlerFile: "src/tools/approve.ts", docsFile: "docs/tools.md", phase: "approve", description: "Apply approve, reject, or revise to one exact PlanDoc decision", destructive: false },
  ...
  { name: "hy_verify", handlerFile: "src/tools/verify.ts", docsFile: "docs/tools.md", phase: "edit, verify", description: "Run all verification layers through the asynchronous supervisor in one MCP request", destructive: false },
  ...
  { name: "hy_exam_submit", handlerFile: "src/tools/exam-submit.ts", docsFile: "docs/tools.md", phase: "edit, verify", description: "Async verify step 2: validate one complete result set, exact exam bindings, current workflow evidence, and local boundaries before persisting the implementation manifest and digest", destructive: false },
  ...
  { name: "hy_commit", handlerFile: "src/tools/commit.ts", docsFile: "docs/tools.md", phase: "commit", description: "Commit approved scope, create PR, and run the commit.ci stage until green", destructive: true },
  { name: "hy_merge", handlerFile: "src/tools/merge.ts", docsFile: "docs/tools.md", phase: "merge", description: "Merge without a second approval and run the merge.sync downstream stage", destructive: true },
